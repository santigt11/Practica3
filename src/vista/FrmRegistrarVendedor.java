...
public class FrmRegistrarVendedor extends javax.swing.JFrame {
    ...
    private void ordenar(){
        ...
        try {
            ...
            mtp.setVendedores(va.ordenar(va.all(), criterio, tipo, tipo_Ordenar));
            tbVendedor.setModel(mtp);
            tbVendedor.updateUI();
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        cbxCriterio.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Apellidos", "Nombres", "Id", "Cedula" }));
